...
class Runner(BaseRunner[None]):  # if a graph is added, Any needs to replaced
    ...
    def run(
        ...
        if files:
            self._load_files(files, self.definitions, definitions_raw)
        ...
        if root_folder:
            for root, d_names, f_names in os.walk(root_folder):
                ...
                self._load_files(files_to_load=files_to_load, definitions=self.definitions, definitions_raw=definitions_raw)
